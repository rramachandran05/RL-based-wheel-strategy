...
> **Open items:** MCB opportunity scan (SPEC-011 §6, specced 2026-09-01 — advisory below-band scan with ROC economics; not yet implemented), G6 (leveraged-ETF technical anchors — reframed by MCB's ETF zones), G7 (retrospective net-basis-gate A/B with proxy ceilings), G8 (below-band opportunity backtest gating any executable promotion of the §6 scan), fallback-share gating in evaluations, lockfile/CI/README reproducibility, bootstrap CIs.
